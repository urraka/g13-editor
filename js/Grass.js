...
inherit(Grass, g13.Object);

var cache = {
	matrix1: mat3.create()
};

function grass_elements(sprites)
{
	return {
		floors: [
			sprites["floor-1.png"],
...
function Grass(points, spritesheet)
{
	this.base.call(this);
	this.batch = null;
	...
	var scale = 0.15;
	var elements = grass_elements(spritesheet.sprites);
	var sprites = [];
...
Grass.prototype.snaptest = function(x, y, r, p)
{
...
Grass.prototype.hittest = function(x, y)
{
	var p = this.points;
...
Grass.prototype.intersects = function(x, y, w, h)
{
	var p = this.points;
...
Grass.prototype.contained = function(x, y, w, h)
{
	var a = this.bounds;
